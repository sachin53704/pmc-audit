...
class Audit extends BaseModel
{
    ...
    protected $fillable = ['department_id', 'audit_no', 'date', 'description', 'file_path', 'status', 'reject_reason', 'dl_description', 'dl_file_path', 'obj_date', 'obj_subject', 'dymca_status', 'dymca_remark', 'mca_status', 'mca_remark'];
