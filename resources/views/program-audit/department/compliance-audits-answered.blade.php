<x-admin.layout>
    <x-slot name="title">Compliance Audit</x-slot>
    <x-slot name="heading">Compliance Audit</x-slot>
                            ...
                            <tbody>
                                @foreach ($audits as $audit)
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-secondary viewObjection px-2 py-1" title="Add Compliance" data-controls-modal="addObjectionModal" data-backdrop="static" data-keyboard="false" data-id="{{ $audit->id }}">@if(Auth::user()->hasRole('Department'))<i data-feather="file-plus"></i> View Compliance @else View Compliance @endif</button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div>
                                                        ...
                                                        <div id="departmentHodStatus" class="accordion-collapse collapse" aria-labelledby="accordionwithplusExample2" data-bs-parent="#accordionWithplusicon">
                                                            <div class="row px-3 py-2">
                                                                ...
                                                                <div class="col-6">
                                                                    ...
                                                                    <select @if(!Auth::user()->hasRole('Department HOD'))disabled @endif name="department_hod_final_status" class="form-select">
                                                                ...
                                                                <div class="col-6">
                                                                    ...
                                                                    <textarea @if(!Auth::user()->hasRole('Department HOD'))disabled @endif name="department_hod_final_remark" class="form-control"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div id="mcaForwardToAuditor" class="accordion-collapse collapse" aria-labelledby="accordionwithplusExample3" data-bs-parent="#accordionWithplusicon">
                                                            <div class="row px-3 py-2">
                                                                ...
                                                                <div class="col-6">
                                                                    ...
                                                                    <textarea @if(!Auth::user()->hasRole('MCA'))disabled @endif name="department_mca_second_remark" class="form-control"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div id="auditorStatus" class="accordion-collapse collapse" aria-labelledby="accordionwithplusExample2" data-bs-parent="#accordionWithplusicon">
                                                            <div class="row px-3 py-2">
                                                                ...
                                                                <div class="col-3 px-3 pt-2">
                                                                    ...
                                                                    <input type="number" class="form-control" name="completed_sub_unit" @if(!Auth::user()->hasRole('Auditor'))disabled @endif>
                                                                </div>

                                                                <div class="col-3 px-3 pt-2">
                                                                    <label for="auditor_status">Pending Objection <span class="text-danger">*</span></label>
                                                                    <input type="number" class="form-control" name="pending_sub_unit" @if(!Auth::user()->hasRole('Auditor'))disabled @endif>
                                                                </div>

                                                                <div class="col-3 px-3 pt-2">
                                                                    <label for="auditor_status">Auditor Status <span class="text-danger">*</span></label>
                                                                    <select name="auditor_status" class="form-select" @if(!Auth::user()->hasRole('Auditor'))disabled @endif>
                                                                        <option value="">Select Status</option>
                                                                ...
                                                                <div class="col-3">
                                                                    ...
                                                                    <textarea name="auditor_remark" class="form-control" @if(!Auth::user()->hasRole('Auditor'))disabled @endif></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div id="dymcaStatus" class="accordion-collapse collapse @if(Auth::user()->hasRole('DY MCA')) show @endif" aria-labelledby="accordionwithplusExample2" data-bs-parent="#accordionWithplusicon">
                                                            <div class="row px-3 py-2">
                                                                ...
                                                                <div class="col-6">
                                                                    ...
                                                                    <textarea @if(!Auth::user()->hasRole('DY MCA'))disabled @endif name="dymca_final_remark" class="form-control"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div id="mcaStatus" class="accordion-collapse collapse @if(Auth::user()->hasRole('MCA')) show @endif" aria-labelledby="accordionwithplusExample2" data-bs-parent="#accordionWithplusicon">
                                                            <div class="row px-3 py-2">
                                                                ...
                                                                <div class="col-6">
                                                                    ...
                                                                    <textarea @if(!Auth::user()->hasRole('MCA'))disabled @endif name="mca_final_remark" class="form-control"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <input type="hidden" name="is_draft_save" value="1" id="isDepartmentDraftSave">
                        </div>
...
<script>
    $(document).ready(function(){
        $('#saveDraftObjectionStatus').click(function(){
            $('#isDepartmentDraftSave').val(1)
        });
        $('#saveObjectionStatus').click(function(){
            $('#isDepartmentDraftSave').val(0)
        });
    })
</script>
        ...
        $.ajax({
            ...
            success: function(data, textStatus, jqXHR)
            {
                ...
                if(data.auditObjection.dymca_final_status == "1" && roleName != "Auditor"){
                    ...
                    $('#savetObjectionStatus').addClass('d-none');
                }
...
<script>
    $("#addForm").submit(function(e) {
        ...
        var url = "{{ route('saveDepartmentCompliance') }}";
