@include('letter.header')
    ...
    <section>
        <p style="text-align: justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;आपल्या विभागाचे सन {{ convertToMarathiNumerals($audit->from->name) }} ते {{ convertToMarathiNumerals($audit->to->name) }} या कालावधीचे अंतर्गत लेखापरीक्षण दिनांक @if($from && $from != ""){{ convertToMarathiNumerals(date('d-m-Y', strtotime($from))) }} @else --------@endif ते @if($to && $to != ""){{ convertToMarathiNumerals(date('d-m-Y', strtotime($to))) }} @else --------@endif या कालावधीत पूर्ण करण्यात आले आहे. सदर अंतर्गत प्रारूप लेखा परीक्षण अहवाल तयार करण्यात आले आहे.</p>
