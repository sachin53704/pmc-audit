! function() {
    ...
    function n(e) {
        document.getElementById("header-lang-img") && ("en" == e ? document.getElementById("header-lang-img").src = "/admin/images/en.png" : "sp" == e ? document.getElementById("header-lang-img").src = "/admin/images/mr.png" : "gr" == e ? document.getElementById("header-lang-img").src = "admin/images/flags/germany.svg" : "it" == e ? document.getElementById("header-lang-img").src = "admin/images/flags/italy.svg" : "ru" == e ? document.getElementById("header-lang-img").src = "admin/images/flags/russia.svg" : "ch" == e ? document.getElementById("header-lang-img").src = "admin/images/flags/china.svg" : "fr" == e ? document.getElementById("header-lang-img").src = "admin/images/flags/french.svg" : "ar" == e && (document.getElementById("header-lang-img").src = "admin/images/flags/ae.svg"), localStorage.setItem("language", e), null == (a = localStorage.getItem("language")) && n(t), (e = new XMLHttpRequest).open("GET", "assets/lang/" + a + ".json"), e.onreadystatechange = function() {
            var a;
